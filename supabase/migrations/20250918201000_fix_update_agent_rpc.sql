-- Fix the update_agent_profile RPC function to resolve ambiguous column reference
...
BEGIN
  ...
  SET 
    ...
    email = COALESCE(email_param, profiles.email),
...
GRANT EXECUTE ON FUNCTION public.update_agent_profile(uuid, text, text, text, text) TO authenticated;
