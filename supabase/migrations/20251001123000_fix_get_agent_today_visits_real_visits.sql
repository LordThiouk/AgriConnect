-- ============================================================================
-- FIX: get_agent_today_visits pour retourner de vraies visites
-- ============================================================================
-- Problème: Le RPC retourne des IDs de parcelles au lieu d'IDs de visites
-- Solution: Modifier pour retourner les vraies visites de la table visits
-- ============================================================================
...
BEGIN
    ...
    WHERE assigned_by_id = v_agent_profile_id 
...
BEGIN
  ...
  RAISE NOTICE '╔════════════════════════════════════════════════════════╗';
  RAISE NOTICE '║                                                        ║';
  RAISE NOTICE '║      RPC VISITES CORRIGÉ - VRAIES VISITES             ║';
  RAISE NOTICE '║                                                        ║';
  RAISE NOTICE '╚════════════════════════════════════════════════════════╝';
  RAISE NOTICE '';
  RAISE NOTICE 'Changements:';
  RAISE NOTICE '  ✓ Retourne de vraies visites depuis la table visits';
  RAISE NOTICE '  ✓ Filtre par agent_id et date du jour';
  RAISE NOTICE '  ✓ Jointure avec producers et plots pour les détails';
  RAISE NOTICE '  ✓ Mapping correct des statuts (scheduled → à faire)';
  RAISE NOTICE '  ✓ Vérification GPS basée sur pl.location';
  RAISE NOTICE '';
