-- Migration: Corriger RLS pour get_visit_for_edit
-- Description: Permettre aux agents d'accéder aux visites via agent_assignments
-- Date: 2025-01-01

-- Corriger la fonction get_visit_for_edit pour gérer correctement les assignations
...
BEGIN
    ...
    -- Soit via agent_assignments, soit via rôle superviseur/admin
    IF NOT EXISTS (
...
-- Commentaire
COMMENT ON FUNCTION get_visit_for_edit(UUID) IS 'Récupère une visite avec producteur et parcelle pour modification (RLS corrigée)';
