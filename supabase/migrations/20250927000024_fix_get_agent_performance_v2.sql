-- Fix get_agent_performance function with correct column names
-- Drop existing function
DROP FUNCTION IF EXISTS get_agent_performance(UUID);

-- Create corrected version with proper column names
...
-- Add comment
COMMENT ON FUNCTION get_agent_performance(UUID) IS 'Returns performance metrics for an agent using correct column names';
