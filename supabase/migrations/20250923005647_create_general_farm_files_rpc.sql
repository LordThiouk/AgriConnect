-- Create general RPC function for farm files with statistics and filtering
-- This function can handle various filters and returns farm files with calculated statistics
...
-- Add comment
COMMENT ON FUNCTION get_farm_files_with_stats(TEXT, TEXT, TEXT, UUID, UUID, INTEGER, INTEGER) IS 'Récupère les fiches d''exploitation avec statistiques et filtres avancés';
