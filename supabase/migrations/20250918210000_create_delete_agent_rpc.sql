-- Create RPC function to safely delete an agent with cascade handling
...
BEGIN
  ...
  -- 2. Delete visits where agent is the performer
  DELETE FROM public.visits 
  WHERE performed_by = agent_id_param;

  -- 3. Delete audit logs related to this agent
