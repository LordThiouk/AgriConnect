-- Final fix for plots RPC functions - ensure all types match exactly
...
-- Drop and recreate get_plots_with_geolocation function with correct types
...
BEGIN
  ...
  SELECT 
    ...
    ffp.area_hectares,
    ffp.soil_type,
    COALESCE(ffp.soil_ph, 0)::NUMERIC as soil_ph,  -- Ensure NUMERIC type
    ffp.water_source,
    ffp.irrigation_type,
    ffp.slope_percent,
