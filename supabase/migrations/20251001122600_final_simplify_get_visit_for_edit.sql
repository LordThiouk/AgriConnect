-- Migration: Simplification finale de get_visit_for_edit
-- Description: RPC ultra-simple sans vérification de profil agent
-- Date: 2025-01-01

-- RPC ultra-simplifié pour get_visit_for_edit
...
DECLARE
    result JSON;
BEGIN
    -- Récupérer la visite avec producteur et parcelle (sans vérification RLS complexe)
...
-- Commentaire
COMMENT ON FUNCTION get_visit_for_edit(UUID) IS 'Récupère une visite avec producteur et parcelle pour modification (ultra-simplifié)';
