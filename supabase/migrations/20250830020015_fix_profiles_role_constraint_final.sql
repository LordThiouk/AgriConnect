-- Fix profiles table role constraint to support all user roles (Final)
-- This migration only updates the role constraint without touching auth.users triggers
