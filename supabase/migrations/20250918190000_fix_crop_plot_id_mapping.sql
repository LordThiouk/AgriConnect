-- Corriger la fonction RPC create_crop_for_agent pour utiliser farm_file_plot_id
DROP FUNCTION IF EXISTS create_crop_for_agent(UUID, TEXT, TEXT, TIMESTAMPTZ, UUID, UUID);

-- Créer la fonction RPC corrigée avec farm_file_plot_id
...
BEGIN
  ...
  -- Créer la culture avec farm_file_plot_id au lieu de plot_id
  INSERT INTO crops (
    id,
    farm_file_plot_id,
    season_id,
