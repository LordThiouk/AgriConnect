-- Fix create_notification to actually insert data instead of simulating
...
COMMENT ON FUNCTION create_notification IS 'Crée une nouvelle notification dans la table notifications';
