-- Migration: Corriger les colonnes plots dans get_visit_for_edit
-- Description: Utiliser les vraies colonnes de la table plots
-- Date: 2025-01-01

-- RPC final avec les bonnes colonnes plots
...
-- Commentaire
COMMENT ON FUNCTION get_visit_for_edit(UUID) IS 'Récupère une visite avec producteur et parcelle pour modification (colonnes plots corrigées)';
