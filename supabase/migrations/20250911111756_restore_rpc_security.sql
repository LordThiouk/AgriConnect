-- Restaure la fonction RPC `get_farm_files` dans sa version sécurisée
-- qui s'exécute avec les droits de l'appelant (SECURITY INVOKER)
-- et respecte les politiques RLS.
