-- Migration: Corriger les colonnes dans get_visit_for_edit
-- Description: Utiliser les bonnes colonnes de la table producers
-- Date: 2025-01-01

-- RPC corrigé avec les bonnes colonnes
...
-- Commentaire
COMMENT ON FUNCTION get_visit_for_edit(UUID) IS 'Récupère une visite avec producteur et parcelle pour modification (colonnes corrigées)';
