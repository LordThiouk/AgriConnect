-- Fix the delete_plot_cascade function to include visits table deletion
...
DECLARE
  ...
  deleted_visits_count INTEGER := 0;
BEGIN
  -- Start transaction
  BEGIN
    ...
    -- 3. Delete visits related to the plot
    DELETE FROM public.visits 
    WHERE plot_id = plot_id_param;
    GET DIAGNOSTICS deleted_visits_count = ROW_COUNT;

    -- 4. Delete recommendations related to the plot or its crops
    ...
    result := json_build_object(
      ...
      'deleted_visits', deleted_visits_count,
