-- Version de débogage de la fonction RPC `get_farm_files`.
-- Utilise SECURITY DEFINER pour ignorer les RLS pendant le test.
-- Le filtre se fait explicitement sur le p_agent_id passé en paramètre.
