...
BEGIN
  ...
  SELECT 
    ...
    ar.severity,
    ar.is_active,
    -- Convertir text[] en jsonb simplement
    to_jsonb(ar.applicable_crops::text[]) as applicable_crops,
    to_jsonb(ar.applicable_regions::text[]) as applicable_regions,
    ar.created_at,
    ar.updated_at,
    total_count::bigint
  FROM agri_rules ar
...
-- Fix get_notifications_with_details - version simplifiée
